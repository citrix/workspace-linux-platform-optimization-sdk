# Platform Optimization SDK for Citrix Receiver for Linux 13.9

# Compatibility with Receiver 

This is Version 13.9 of the Platform Optimization SDK. It is intended for use with Linux Receiver builds in the 13.9 series. There are separate versions of the SDK for each of the released architectures (X86, X86_64 and ARMhf) that differ only in the included binaries. 
